    ...
    <div class="property-fields property-contact">
        ...
        <div class="col-sm-6">
            ...
            <div class="form-check form-group">
                <input class="form-check-input" type="radio" name="agent_display_option" id="agent_display_option_1" value="author_info" checked>
            ...
            <div class="form-check form-group">
                <input class="form-check-input" type="radio" name="agent_display_option" id="agent_display_option_2" value="other_info">
