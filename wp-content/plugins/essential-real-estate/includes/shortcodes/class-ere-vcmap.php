...
if ( ! class_exists( 'ERE_Vc_map' ) ) {
	...
	class ERE_Vc_map {
		...
		public function register_vc_map() {
            ...
            vc_map( array(
                'name'     => esc_html__( 'Nearby Places', 'essential-real-estate' ),
                'base'     => 'ere_nearby_places',
                'icon'     => 'fa fa-map-marker',
                'category' => esc_html__( 'ERE Shortcode', 'essential-real-estate' ),
                'params' => array(
                    array(
                    ...
                    array(
                        'type' => 'dropdown',
                        'heading' => esc_html__('Rank by', 'essential-real-estate'),
                        'param_name' => 'rank_by',
                        'value' => array(
                            esc_html__('Prominence', 'essential-real-estate') => 'default',
                            esc_html__('Distance', 'essential-real-estate') => 'distance'
                        ),
                        'edit_field_class' => 'vc_col-sm-6 vc_column',
                    ),
                    array(
                        'type' => 'textfield',
                        'heading' => esc_html__('Radius', 'essential-real-estate'),
                        'param_name' => 'radius',
                        'value' => '5000',
                    ...
                    array(
                        'type' => 'dropdown',
                        'heading' => esc_html__('Near by places distance in', 'essential-real-estate'),
                        'param_name' => 'distance_in',
                        'value' => array(
                            esc_html__('Meter', 'essential-real-estate') => 'm',
                            esc_html__('Km', 'essential-real-estate') => 'km',
                            esc_html__('Mile', 'essential-real-estate') => 'mi',
                        ),
                        'std' => 'km',
                        'edit_field_class' => 'vc_col-sm-6 vc_column',
                    ),
                    array(
                        'type' => 'textfield',
                        'heading' => esc_html__('Map Height', 'essential-real-estate'),
                        'param_name' => 'map_height',
                        'value' => 475,
                        'edit_field_class' => 'vc_col-sm-6 vc_column',
                    ),
                    array(
                        'type'        => 'textfield',
                        'heading'     => esc_html__( 'Extra class name', 'essential-real-estate' ),
                        'param_name'  => 'el_class',
                        'description' => esc_html__( 'Style particular content element differently - add a class name and refer to it in custom CSS.', 'essential-real-estate' ),
                    )
                )
